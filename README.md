...
- a pinned CometBFT v0.39.3 ABCI++ application with strict genesis/consensus-parameter binding, deterministic proposal replay, candidate-only finalize, single and simultaneous evidence-driven `chainlab-v2` validator removal, Pebble-backed incremental history profiles, and verified snapshot restore
