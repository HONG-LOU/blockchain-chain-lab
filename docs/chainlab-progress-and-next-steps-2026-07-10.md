...
- Runtime admission/re-entry and power changes, unbonding/rewards, and key operations remain disabled; the offline genesis certificate path is not a completed dynamic staking lifecycle.
