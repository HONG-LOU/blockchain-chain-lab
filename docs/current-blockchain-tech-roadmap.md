...
- Keep fee and metering honest about scope: ChainLab now has a local EIP-1559-style base fee, base fee burn, priority fee rewards, uploaded WASM bytecode fees, host ABI storage/event/arg/return resource gas, and deterministic static WASM function-body fuel; runtime step interruption and Ethereum type-2 raw transaction compatibility remain separate milestones.
