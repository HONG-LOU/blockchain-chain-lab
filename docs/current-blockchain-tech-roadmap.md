...
- Extend the implemented normal-round, 3-of-4 progress, 2-of-4 halt/recovery, reconnect, restart, app-replay, block-sync, state-sync, real duplicate-vote, and rolling-application process tests with delayed/missing proposers, actual network partitions/message faults, simultaneous changes, light-client attacks, load, Comet binary upgrades, and staged operator drills.
