...
- Extend the implemented normal-round, 3-of-4 progress, targeted missing-proposer round advancement, 2-of-4 halt/recovery, symmetric partition/heal, reconnect, restart, app-replay, block-sync, state-sync, single/simultaneous evidence-driven validator removal, and rolling-application process tests with delayed-but-connected proposers, dynamic delay/drop/reorder and asymmetric partitions, light-client attacks, non-removal power/admission changes, load, Comet binary upgrades, and staged operator drills.
