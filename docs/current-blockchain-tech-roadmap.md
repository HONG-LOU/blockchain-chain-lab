...
- Treat txpool policy as consensus-adjacent operational logic, not only an RPC detail. ChainLab now supports 10 percent same-sender/same-nonce pending transaction replacement for legacy gas-price and EIP-1559-style fee-cap transactions; queued nonce-gap pools, eviction, journaling, capacity limits, local exemptions, and MEV-aware ordering remain separate milestones.
